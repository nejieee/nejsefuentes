var Scoreboardlose = function(game){
    Phaser.Group.call(this, game);
};
Scoreboardlose.prototype = Object.create(Phaser.Group.prototype);
Scoreboardlose.prototype.constructor = Scoreboardlose;
...
Scoreboardlose.prototype.show = function(score,kill){
    ...
    gameoverText =  this.game.add.bitmapText(0, 60, 'minecraftia', 'GAME OVEEEER!', 36);
    gameoverText.x = this.game.width/2 - (gameoverText.textWidth/ 2);
    gameoverText.tint = 0xf40d01;
    this.add(gameoverText);

    gameoverText =  this.game.add.bitmapText(0, 140, 'minecraftia', 'Better luck next game!', 20);
    gameoverText.x = this.game.width/2 - (gameoverText.textWidth/ 2);
    this.add(gameoverText);
...
Scoreboardlose.prototype.restart = function(){
